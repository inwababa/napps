		...
		$.ajax({				
			...
			success : function(response){	
				...
				if(response.status==200){		
                    $("#success").show();				
						$("#success").html('<div class="alert alert-icon alert-success" role="alert"><em class="icon ni ni-check-circle-cut"></em><strong>Success</strong> Airtime recharge of NGN<strong>'+response.amount+'</sctrong> to <strong>'+response.phone+'</strong> is successful.</div>');
