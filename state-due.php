...
<html lang="zxx">
    <head>
        ...
        <title>Pay State Due | NAPPS Pay</title>
...
<script type="text/javascript" src="scripts/data3.js"></script>
        <script>
  $(function () {
...
<script type="text/javascript">
  $(document).ready(function(){ /* PREPARE THE SCRIPT */
    $("#country-list").change(function(){ /* WHEN YOU CHANGE AND SELECT FROM THE SELECT FIELD */
