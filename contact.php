...
<html lang="zxx">
    <head>
        ...
        <title>Contact Us | Funaab Pay</title>
                    ...
                    <nav class="navbar navbar-expand-md navbar-light">
                        ...
                        <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item"><a href="contact-us" class="nav-link active">Contact</a></li>
                            </ul>
            ...
            <div class="container">
                ...
                <div class="row">
                      ...
                      <div class="contact-info">
                          <ul>
                              ...
                              <li>
                                  ...
                                  <span>Email</span>
                                  <a href="mailto:support@funaabpay.com.ng">support@funaabpay.com.ng</a>
                                  <a href="mailto:titangalaxyng@gmail.com">titangalaxyng@gmail.com</a>
                              </li>
                              ...
                              <li>
                                  ...
                                  <span>Phone</span>
                                  <a href="tel:+2349032751557">+234 9032751557</a>
                                  <a href="tel:+2348107129711">+234 8107129711</a>
                                   <a href="tel:+234816296126">+234 8162961126</a>
                              </li>
                          </ul>
                      </div>
                  </div>
                  ...
                  <div class="col-lg-7 col-md-12">
                      ...
                      <div id="success" class="h6 text-center hidden"></div>
                                      <div id="error" class="h6 text-center hidden"></div>
                          ...
                          <form id="contactForm">
                              <div class="row">
                                  ...
                                  <div class="col-lg-12 col-md-12">
                                      <button type="submit" name="login_button" id="login_button" class="btn btn-primary">Send Message</button>
